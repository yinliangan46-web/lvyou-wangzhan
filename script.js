...
const destinationData = {
    ...
    bali: {
        ...
        days: '5天4晚',
        price: '¥2,799',
        img: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=800photo-1528164344705-47542687000d?w=800&q=80q=80',
    ...
    // ==== 中国省会/直辖市 ====
    beijing: {name:'北京',country:'北京',tag:'千年古都',rating:4.9,days:'5天4晚',price:'¥2,599',img:'https://images.unsplash.com/photo-1724128084927-e6e0c5ce2868',description:'北京，中华人民共和国的首都，一座拥有三千年历史的文化古都。故宫的红墙黄瓦、长城的雄伟壮观、颐和园的皇家园林、胡同里的老北京生活，处处展现着这座城市的独特魅力。',itinerary:[
    ...
    shanghai: {name:'上海',country:'上海',tag:'魔都风情',rating:4.8,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1519501025264-65ba15a82390',description:'上海，中国的经济中心，一座传统与现代完美融合的国际大都市。外滩的万国建筑群、陆家嘴的摩天大楼、豫园的江南园林、弄堂里的市井烟火，共同演绎着"魔都"的独特魅力。',itinerary:[
    ...
    guangzhou: {name:'广州',country:'广东',tag:'食在广州',rating:4.7,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1449824913935-59a10b8d2000',description:'广州，一座有着两千多年历史的文化名城，也是中国南方的美食之都。从早茶到宵夜，从广州塔到沙面，从陈家祠到白云山，美食与美景完美融合。',itinerary:[
    ...
    shenzhen: {name:'深圳',country:'广东',tag:'创新之都',rating:4.6,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1494783367193-149034c05e8f',description:'深圳，中国改革开放的窗口，从一个小渔村蜕变为国际化创新大都市。世界之窗、华侨城、大梅沙海滨公园，展现着这座年轻城市的活力与魅力。',itinerary:[
    ...
    chengdu: {name:'成都',country:'四川',tag:'天府之国',rating:4.9,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1496564203457-11bb12075d90',description:'成都，一座来了就不想走的城市。大熊猫的故乡，美食的天堂。宽窄巷子的悠闲、锦里的繁华、都江堰的千年水利工程，处处散发着"天府之国"的魅力。',itinerary:[
    ...
    hangzhou: {name:'杭州',country:'浙江',tag:'人间天堂',rating:4.8,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1467269204594-9661b134dd2b',description:'杭州，"上有天堂，下有苏杭"。西湖的断桥残雪、雷峰夕照，灵隐寺的钟声，龙井茶的清香，让这座城市充满了诗意与浪漫。',itinerary:[
    ...
    xian: {name:'西安',country:'陕西',tag:'千年古都',rating:4.8,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1507525428034-b723cf961d3e',description:'西安，十三朝古都，中华文明的发源地之一。秦始皇兵马俑的震撼、古城墙的雄伟、大雁塔的庄严、回民街的美食，让你穿越千年感受历史的厚重。',itinerary:[
    ...
    chongqing: {name:'重庆',country:'重庆',tag:'8D魔幻之城',rating:4.7,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4',description:'重庆，一座建在山上的城市，被称为"8D魔幻城市"。洪崖洞的吊脚楼、李子坝轻轨穿楼、长江索道、麻辣火锅，每一个元素都让人流连忘返。',itinerary:[
    ...
    wuhan: {name:'武汉',country:'湖北',tag:'江城名片',rating:4.6,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227',description:'武汉，长江与汉江的交汇处，"九省通衢"的枢纽城市。黄鹤楼的千年诗韵、武大樱花的浪漫、户部巷的美食、东湖的碧波，构成了这座江城的独特魅力。',itinerary:[
    ...
    changsha: {name:'长沙',country:'湖南',tag:'娱乐之都',rating:4.6,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1514282401047-d79a71a590e8',description:'长沙，一座充满活力的娱乐之都。岳麓书院的书香、橘子洲头的伟人风采、太平街的美食、茶颜悦色的网红奶茶，让这座千年古城焕发着青春活力。',itinerary:[
    ...
    nanjing: {name:'南京',country:'江苏',tag:'六朝古都',rating:4.8,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'南京，六朝古都，十朝都会。中山陵的庄严肃穆、夫子庙的秦淮风情、明孝陵的皇家气派、南京博物院的文化珍藏，处处彰显着这座历史文化名城的深厚底蕴。',itinerary:[
    ...
    shenyang: {name:'沈阳',country:'辽宁',tag:'共和国长子',rating:4.5,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb',description:'沈阳，辽宁省省会，"共和国长子"，东北地区的中心城市。沈阳故宫的皇家气派、张氏帅府的历史印记、中街的繁华热闹，展现着这座工业重镇的独特魅力。',itinerary:[
    ...
    harbin: {name:'哈尔滨',country:'黑龙江',tag:'冰城夏都',rating:4.5,days:'5天4晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1501785888041-af3ef285b470',description:'哈尔滨，被誉为"东方莫斯科"和"东方小巴黎"。中央大街的欧式建筑、索菲亚大教堂的穹顶、冰雪大世界的奇幻、松花江的壮阔，让你感受北国风光的独特魅力。',itinerary:[
    ...
    kunming: {name:'昆明',country:'云南',tag:'春城花都',rating:4.7,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba',description:'昆明，"春城"之名享誉全国，四季如春的气候让这座城市永远充满生机。石林的鬼斧神工、滇池的碧波万顷、云南民族村的多彩文化，是感受云南之美的绝佳起点。',itinerary:[
    ...
    hefei: {name:'合肥',country:'安徽',tag:'大湖名城',rating:4.5,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227',description:'合肥，安徽省省会，一座融合了历史与创新的城市。包公园的清正廉明、三河古镇的水乡风情、巢湖的烟波浩渺，展现着这座"大湖名城"的独特魅力。',itinerary:[
    ...
    fuzhou: {name:'福州',country:'福建',tag:'榕城古韵',rating:4.5,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb',description:'福州，福建省省会，一座有着两千多年历史的文化名城。三坊七巷的明清建筑、鼓山的摩崖石刻、西湖公园的秀美风光，处处散发着"榕城"的独特魅力。',itinerary:[
    ...
    nanchang: {name:'南昌',country:'江西',tag:'英雄之城',rating:4.4,days:'3天2晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1519501025264-65ba15a82390',description:'南昌，江西省省会，"英雄城"的美誉源于八一起义。滕王阁的千古绝唱、八一起义纪念馆的红色记忆、鄱阳湖的候鸟天堂，让这座城市充满了历史与自然的双重魅力。',itinerary:[
    ...
    zhengzhou: {name:'郑州',country:'河南',tag:'天地之中',rating:4.4,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'郑州，河南省省会，地处中华腹地，"天地之中"。黄河风景区的壮阔、少林寺的禅武合一、河南博物院的文物珍藏，带你领略中原文化的博大精深。',itinerary:[
    ...
    jinan: {name:'济南',country:'山东',tag:'泉城风光',rating:4.5,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1501785888041-af3ef285b470',description:'济南，山东省省会，以"泉城"闻名天下。趵突泉的三股泉水、大明湖的荷风柳韵、千佛山的石刻造像、芙蓉街的美食飘香，构成了一幅"家家泉水，户户垂杨"的美景。',itinerary:[
    ...
    shijiazhuang: {name:'石家庄',country:'河北',tag:'燕赵风骨',rating:4.3,days:'3天2晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4',description:'石家庄，河北省省会，一座充满活力的现代都市。西柏坡的红色记忆、正定古城的千年历史、赵州桥的建筑奇迹，让这座城市既有历史的厚重又有现代的繁华。',itinerary:[
    ...
    taiyuan: {name:'太原',country:'山西',tag:'晋商故里',rating:4.4,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba',description:'太原，山西省省会，一座拥有两千五百多年建城史的文化古城。晋祠的千年古柏、天龙山的石窟造像、山西博物院的青铜珍藏，让人感受三晋大地的深厚文化底蕴。',itinerary:[
    ...
    huhehaote: {name:'呼和浩特',country:'内蒙古',tag:'草原青城',rating:4.4,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1496564203457-11bb12075d90',description:'呼和浩特，内蒙古自治区首府，"青城"之意。广阔无垠的希拉穆仁草原、庄严的席力图召、热闹的塞上老街，让你感受草原文化与城市文明的完美融合。',itinerary:[
    ...
    changchun: {name:'长春',country:'吉林',tag:'北国春城',rating:4.3,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1501785888041-af3ef285b470',description:'长春，吉林省省会，"北国春城"。伪满皇宫的历史印记、净月潭的国家森林公园、长影世纪城的电影文化，让这座城市充满了历史与自然的双重魅力。',itinerary:[
    ...
    nanning: {name:'南宁',country:'广西',tag:'绿城南宁',rating:4.4,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1467269204594-9661b134dd2b',description:'南宁，广西壮族自治区首府，被誉为"绿城"。青秀山的葱郁、南湖的宁静、中山路的美食、广西民族博物馆的多彩文化，展现着这座南国城市的独特魅力。',itinerary:[
    ...
    haikou: {name:'海口',country:'海南',tag:'椰风海韵',rating:4.5,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1514282401047-d79a71a590e8',description:'海口，海南省省会，一座充满热带风情的海滨城市。骑楼老街的南洋风情、假日海滩的阳光沙滩、火山口公园的地质奇观，让你感受椰风海韵的惬意生活。',itinerary:[
    ...
    guiyang: {name:'贵阳',country:'贵州',tag:'避暑之都',rating:4.5,days:'5天4晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'贵阳，贵州省省会，"避暑之都"的美誉名副其实。黄果树瀑布的壮阔、荔波小七孔的秀美、黔灵山的灵秀、酸汤鱼的鲜美，让这座城市成为越来越受欢迎的旅游目的地。',itinerary:[
    ...
    lasa: {name:'拉萨',country:'西藏',tag:'日光之城',rating:4.9,days:'7天6晚',price:'¥2,799',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba',description:'拉萨，西藏自治区首府，"日光之城"。布达拉宫的雄伟壮丽、大昭寺的虔诚信仰、八廓街的转经人流、纳木错的圣湖碧水，让人心灵得到净化和升华。',itinerary:[
    ...
    lanzhou: {name:'兰州',country:'甘肃',tag:'黄河之都',rating:4.4,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1449824913935-59a10b8d2000',description:'兰州，甘肃省省会，黄河穿城而过的唯一省会城市。百年中山桥的铁骨铮铮、白塔山的俯瞰全城、正宁路夜市的烟火气息、一碗地道的兰州牛肉面，是这座西北之城的独特名片。',itinerary:[
    ...
    xining: {name:'西宁',country:'青海',tag:'夏都西宁',rating:4.4,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1501785888041-af3ef285b470',description:'西宁，青海省省会，被誉为"夏都"。青海湖的碧波万顷、塔尔寺的藏传佛教文化、茶卡盐湖的天空之镜，让这座城市成为青藏高原上一颗璀璨的明珠。',itinerary:[
    ...
    yinchuan: {name:'银川',country:'宁夏',tag:'塞上江南',rating:4.3,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb',description:'银川，宁夏回族自治区首府，"塞上江南"的美称。西夏王陵的千年神秘、沙湖的沙漠与湖泊共生、镇北堡西部影城的电影情怀，让人感受到西北大地的独特魅力。',itinerary:[
    ...
    urumqi: {name:'乌鲁木齐',country:'新疆',tag:'亚心之都',rating:4.5,days:'6天5晚',price:'¥2,799',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba',description:'乌鲁木齐，新疆维吾尔自治区首府，亚洲大陆的地理中心。天山天池的雪山倒影、大巴扎的异域风情、南山牧场的辽阔草原，让你感受多元文化交融的独特魅力。',itinerary:[
    ...
    // 额外城市
    guilin: {name:'桂林',country:'广西',tag:'山水甲天下',rating:4.8,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4',description:'桂林，"桂林山水甲天下"名扬四海。漓江的百里画廊、阳朔的十里画廊、龙脊梯田的壮美、象鼻山的奇特，构成了一幅流动的山水画卷。',itinerary:[
    ...
    dali: {name:'大理',country:'云南',tag:'风花雪月',rating:4.7,days:'4天3晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1467269204594-9661b134dd2b',description:'大理，"风花雪月"的浪漫之地。洱海的碧波、苍山的雪顶、大理古城的悠然、崇圣寺三塔的庄严，让这座古城成为无数人心中的诗和远方。',itinerary:[
    ...
    // ==== 热门旅游城市 ====
    suzhou: {name:'苏州',country:'江苏',tag:'江南园林甲天下',rating:4.7,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1494783367193-149034c05e8f',description:'苏州，"上有天堂，下有苏杭"。拙政园的亭台楼榭、留园的曲径通幽、周庄的小桥流水、虎丘的千年斜塔，无处不彰显着江南水乡的诗情画意。',itinerary:[
    ...
    qingdao: {name:'青岛',country:'山东',tag:'红瓦绿树碧海蓝天',rating:4.6,days:'4天3晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1514282401047-d79a71a590e8',description:'青岛，一座让人来了就不想走的海滨城市。栈桥的海鸥、八大关的万国建筑、崂山的道教文化、啤酒节的狂欢，处处洋溢着这座岛城的独特魅力。',itinerary:[
    ...
    xiamen: {name:'厦门',country:'福建',tag:'海上花园',rating:4.7,days:'4天3晚',price:'¥2,499',img:'https://images.unsplash.com/photo-1449824913935-59a10b8d2000',description:'厦门，一座风姿绰约的海上花园。鼓浪屿的万国建筑、环岛路的椰风海韵、曾厝垵的文艺气息、南普陀的晨钟暮鼓，让这座海滨城市充满了浪漫与诗情。',itinerary:[
    ...
    lijiang: {name:'丽江',country:'云南',tag:'雪山下的古城',rating:4.8,days:'5天4晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227',description:'丽江，一个让人心灵栖息的远方。大研古城的纳西风情、玉龙雪山的巍峨壮丽、束河古镇的宁静悠然、泸沽湖的摩梭文化，每一处都是诗和远方的模样。',itinerary:[
    ...
    zhangjiajie: {name:'张家界',country:'湖南',tag:'奇峰三千秀水八百',rating:4.8,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4',description:'张家界，阿凡达取景地，一座被大自然偏爱的山水画卷。天门山的惊险、天子山的奇峰、金鞭溪的清澈、大峡谷的玻璃桥，每一步都是视觉的盛宴。',itinerary:[
    ...
    huangshan: {name:'黄山',country:'安徽',tag:'五岳归来不看山',rating:4.9,days:'4天3晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba',description:'黄山，"五岳归来不看山，黄山归来不看岳"。奇松、怪石、云海、温泉、冬雪，"五绝"闻名天下。迎客松的挺拔、光明顶的日出、西海大峡谷的险峻，让人感叹大自然的鬼斧神工。',itinerary:[
    ...
    jiuzhaigou: {name:'九寨沟',country:'四川',tag:'人间仙境童话世界',rating:4.9,days:'5天4晚',price:'¥2,599',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4',description:'九寨沟，被誉为"童话世界"。翠海、叠瀑、彩林、雪峰、藏情、蓝冰，六绝奇观令人叹为观止。五花海的斑斓、诺日朗瀑布的壮观、长海的静谧，每一帧都美如画卷。',itinerary:[
    ...
    dunhuang: {name:'敦煌',country:'甘肃',tag:'丝路明珠',rating:4.7,days:'5天4晚',price:'¥2,799',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227',description:'敦煌，丝绸之路上的明珠，一座承载着千年文明的文化圣地。莫高窟的壁画、鸣沙山的驼铃、月牙泉的碧波、雅丹地貌的奇幻，让人穿越时空感受丝路的辉煌。',itinerary:[
    ...
    sanya: {name:'三亚',country:'海南',tag:'东方夏威夷',rating:4.7,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1514282401047-d79a71a590e8',description:'三亚，中国最南端的热带滨海旅游城市。亚龙湾的洁白沙滩、蜈支洲岛的清澈海水、天涯海角的浪漫传说、热带天堂森林公园的空中栈道，是避寒度假的绝佳选择。',itinerary:[
    ...
    xishuangbanna: {name:'西双版纳',country:'云南',tag:'热带雨林傣族风情',rating:4.6,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1467269204594-9661b134dd2b',description:'西双版纳，中国唯一的热带雨林自然保护区。野象谷的亚洲象、望天树的空中走廊、傣族园的竹楼、星光夜市的烟火，让你感受浓郁的民族风情和热带风光。',itinerary:[
    ...
    huangguoshu: {name:'黄果树',country:'贵州',tag:'亚洲最大瀑布',rating:4.6,days:'3天2晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'黄果树瀑布，亚洲最大的瀑布，宽101米，高78米。奔腾而下的水流如银河倾泻，水雾弥漫，彩虹横跨，气势磅礴。景区内还有天星桥、陡坡塘等多个景点。',itinerary:[
    ...
    leshan: {name:'乐山',country:'四川',tag:'世界最大石刻坐佛',rating:4.6,days:'3天2晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb',description:'乐山，举世闻名的乐山大佛所在地。大佛通高71米，是世界上最大的石刻弥勒佛坐像，历时90年建成。登临大佛脚下，感受"山是一尊佛，佛是一座山"的震撼。',itinerary:[
