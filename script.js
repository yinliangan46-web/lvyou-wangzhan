...
const destinationData = {
    ...
    // ==== 中国省会/直辖市 ====
    beijing: {name:'北京',country:'北京',tag:'千年古都',rating:4.9,days:'5天4晚',price:'¥2,599',img:'https://images.unsplash.com/photo-1570320324089-8997b16ea7e1?w=800&q=80',description:'北京，中华人民共和国的首都，一座拥有三千年历史的文化古都。故宫的红墙黄瓦、长城的雄伟壮观、颐和园的皇家园林、胡同里的老北京生活，处处展现着这座城市的独特魅力。',itinerary:[
    ...
    shanghai: {name:'上海',country:'上海',tag:'魔都风情',rating:4.8,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1537531383496-f4749b66e522?w=800&q=80',description:'上海，中国的经济中心，一座传统与现代完美融合的国际大都市。外滩的万国建筑群、陆家嘴的摩天大楼、豫园的江南园林、弄堂里的市井烟火，共同演绎着"魔都"的独特魅力。',itinerary:[
    ...
    guangzhou: {name:'广州',country:'广东',tag:'食在广州',rating:4.7,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1571825024545-b4f155927ee5?w=800&q=80',description:'广州，一座有着两千多年历史的文化名城，也是中国南方的美食之都。从早茶到宵夜，从广州塔到沙面，从陈家祠到白云山，美食与美景完美融合。',itinerary:[
    ...
    shenzhen: {name:'深圳',country:'广东',tag:'创新之都',rating:4.6,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=800&q=80',description:'深圳，中国改革开放的窗口，从一个小渔村蜕变为国际化创新大都市。世界之窗、华侨城、大梅沙海滨公园，展现着这座年轻城市的活力与魅力。',itinerary:[
    ...
    chengdu: {name:'成都',country:'四川',tag:'天府之国',rating:4.9,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1590073242678-70ee3fc28f8e?w=800&q=80',description:'成都，一座来了就不想走的城市。大熊猫的故乡，美食的天堂。宽窄巷子的悠闲、锦里的繁华、都江堰的千年水利工程，处处散发着"天府之国"的魅力。',itinerary:[
    ...
    hangzhou: {name:'杭州',country:'浙江',tag:'人间天堂',rating:4.8,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1599571234902-5180d2b1c58d?w=800&q=80',description:'杭州，"上有天堂，下有苏杭"。西湖的断桥残雪、雷峰夕照，灵隐寺的钟声，龙井茶的清香，让这座城市充满了诗意与浪漫。',itinerary:[
    ...
    xian: {name:'西安',country:'陕西',tag:'千年古都',rating:4.8,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1621970186201-7c70d0d74278?w=800&q=80',description:'西安，十三朝古都，中华文明的发源地之一。秦始皇兵马俑的震撼、古城墙的雄伟、大雁塔的庄严、回民街的美食，让你穿越千年感受历史的厚重。',itinerary:[
    ...
    chongqing: {name:'重庆',country:'重庆',tag:'8D魔幻之城',rating:4.7,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1593253787226-567eda4ad32c?w=800&q=80',description:'重庆，一座建在山上的城市，被称为"8D魔幻城市"。洪崖洞的吊脚楼、李子坝轻轨穿楼、长江索道、麻辣火锅，每一个元素都让人流连忘返。',itinerary:[
    ...
    wuhan: {name:'武汉',country:'湖北',tag:'江城名片',rating:4.6,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1602279678626-2572680f8b1b?w=800&q=80',description:'武汉，长江与汉江的交汇处，"九省通衢"的枢纽城市。黄鹤楼的千年诗韵、武大樱花的浪漫、户部巷的美食、东湖的碧波，构成了这座江城的独特魅力。',itinerary:[
    ...
    changsha: {name:'长沙',country:'湖南',tag:'娱乐之都',rating:4.6,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1504384308090-c89484cc64d2?w=800&q=80',description:'长沙，一座充满活力的娱乐之都。岳麓书院的书香、橘子洲头的伟人风采、太平街的美食、茶颜悦色的网红奶茶，让这座千年古城焕发着青春活力。',itinerary:[
    ...
    nanjing: {name:'南京',country:'江苏',tag:'六朝古都',rating:4.8,days:'4天3晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1578088650637-d8d509c1a957?w=800&q=80',description:'南京，六朝古都，十朝都会。中山陵的庄严肃穆、夫子庙的秦淮风情、明孝陵的皇家气派、南京博物院的文化珍藏，处处彰显着这座历史文化名城的深厚底蕴。',itinerary:[
    ...
    shenyang: {name:'沈阳',country:'辽宁',tag:'共和国长子',rating:4.5,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1496564203457-11bb12075d90?w=800&q=80',description:'沈阳，辽宁省省会，"共和国长子"，东北地区的中心城市。沈阳故宫的皇家气派、张氏帅府的历史印记、中街的繁华热闹，展现着这座工业重镇的独特魅力。',itinerary:[
    ...
    harbin: {name:'哈尔滨',country:'黑龙江',tag:'冰城夏都',rating:4.5,days:'5天4晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1611843467160-25afb1de7c7c?w=800&q=80',description:'哈尔滨，被誉为"东方莫斯科"和"东方小巴黎"。中央大街的欧式建筑、索菲亚大教堂的穹顶、冰雪大世界的奇幻、松花江的壮阔，让你感受北国风光的独特魅力。',itinerary:[
    ...
    kunming: {name:'昆明',country:'云南',tag:'春城花都',rating:4.7,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1476514525535-07fb3e4c5f94?w=800&q=80',description:'昆明，"春城"之名享誉全国，四季如春的气候让这座城市永远充满生机。石林的鬼斧神工、滇池的碧波万顷、云南民族村的多彩文化，是感受云南之美的绝佳起点。',itinerary:[
    ...
    hefei: {name:'合肥',country:'安徽',tag:'大湖名城',rating:4.5,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227?w=800&q=80',description:'合肥，安徽省省会，一座融合了历史与创新的城市。包公园的清正廉明、三河古镇的水乡风情、巢湖的烟波浩渺，展现着这座"大湖名城"的独特魅力。',itinerary:[
    ...
    fuzhou: {name:'福州',country:'福建',tag:'榕城古韵',rating:4.5,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1494783367193-149034c05e8f?w=800&q=80',description:'福州，福建省省会，一座有着两千多年历史的文化名城。三坊七巷的明清建筑、鼓山的摩崖石刻、西湖公园的秀美风光，处处散发着"榕城"的独特魅力。',itinerary:[
    ...
    nanchang: {name:'南昌',country:'江西',tag:'英雄之城',rating:4.4,days:'3天2晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1477959853097-8f7d5f0bc97d?w=800&q=80',description:'南昌，江西省省会，"英雄城"的美誉源于八一起义。滕王阁的千古绝唱、八一起义纪念馆的红色记忆、鄱阳湖的候鸟天堂，让这座城市充满了历史与自然的双重魅力。',itinerary:[
    ...
    zhengzhou: {name:'郑州',country:'河南',tag:'天地之中',rating:4.4,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1470004919585-08d11bd32c6d?w=800&q=80',description:'郑州，河南省省会，地处中华腹地，"天地之中"。黄河风景区的壮阔、少林寺的禅武合一、河南博物院的文物珍藏，带你领略中原文化的博大精深。',itinerary:[
    ...
    jinan: {name:'济南',country:'山东',tag:'泉城风光',rating:4.5,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1433086966350-92359d8f86fe?w=800&q=80',description:'济南，山东省省会，以"泉城"闻名天下。趵突泉的三股泉水、大明湖的荷风柳韵、千佛山的石刻造像、芙蓉街的美食飘香，构成了一幅"家家泉水，户户垂杨"的美景。',itinerary:[
    ...
    shijiazhuang: {name:'石家庄',country:'河北',tag:'燕赵风骨',rating:4.3,days:'3天2晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1524492412937-b9bd8a2c7e1c?w=800&q=80',description:'石家庄，河北省省会，一座充满活力的现代都市。西柏坡的红色记忆、正定古城的千年历史、赵州桥的建筑奇迹，让这座城市既有历史的厚重又有现代的繁华。',itinerary:[
    ...
    taiyuan: {name:'太原',country:'山西',tag:'晋商故里',rating:4.4,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&q=80',description:'太原，山西省省会，一座拥有两千五百多年建城史的文化古城。晋祠的千年古柏、天龙山的石窟造像、山西博物院的青铜珍藏，让人感受三晋大地的深厚文化底蕴。',itinerary:[
    ...
    huhehaote: {name:'呼和浩特',country:'内蒙古',tag:'草原青城',rating:4.4,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1469479069859-2f5c9640e0e0?w=800&q=80',description:'呼和浩特，内蒙古自治区首府，"青城"之意。广阔无垠的希拉穆仁草原、庄严的席力图召、热闹的塞上老街，让你感受草原文化与城市文明的完美融合。',itinerary:[
    ...
    changchun: {name:'长春',country:'吉林',tag:'北国春城',rating:4.3,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1504283189877-82e92c076b50?w=800&q=80',description:'长春，吉林省省会，"北国春城"。伪满皇宫的历史印记、净月潭的国家森林公园、长影世纪城的电影文化，让这座城市充满了历史与自然的双重魅力。',itinerary:[
    ...
    nanning: {name:'南宁',country:'广西',tag:'绿城南宁',rating:4.4,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1464822759023-fed622ff2b22?w=800&q=80',description:'南宁，广西壮族自治区首府，被誉为"绿城"。青秀山的葱郁、南湖的宁静、中山路的美食、广西民族博物馆的多彩文化，展现着这座南国城市的独特魅力。',itinerary:[
    ...
    haikou: {name:'海口',country:'海南',tag:'椰风海韵',rating:4.5,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&q=80',description:'海口，海南省省会，一座充满热带风情的海滨城市。骑楼老街的南洋风情、假日海滩的阳光沙滩、火山口公园的地质奇观，让你感受椰风海韵的惬意生活。',itinerary:[
    ...
    guiyang: {name:'贵阳',country:'贵州',tag:'避暑之都',rating:4.5,days:'5天4晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&q=80',description:'贵阳，贵州省省会，"避暑之都"的美誉名副其实。黄果树瀑布的壮阔、荔波小七孔的秀美、黔灵山的灵秀、酸汤鱼的鲜美，让这座城市成为越来越受欢迎的旅游目的地。',itinerary:[
    ...
    lasa: {name:'拉萨',country:'西藏',tag:'日光之城',rating:4.9,days:'7天6晚',price:'¥2,799',img:'https://images.unsplash.com/photo-1540202404-c4541b3e5d7b?w=800&q=80',description:'拉萨，西藏自治区首府，"日光之城"。布达拉宫的雄伟壮丽、大昭寺的虔诚信仰、八廓街的转经人流、纳木错的圣湖碧水，让人心灵得到净化和升华。',itinerary:[
    ...
    lanzhou: {name:'兰州',country:'甘肃',tag:'黄河之都',rating:4.4,days:'4天3晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800&q=80',description:'兰州，甘肃省省会，黄河穿城而过的唯一省会城市。百年中山桥的铁骨铮铮、白塔山的俯瞰全城、正宁路夜市的烟火气息、一碗地道的兰州牛肉面，是这座西北之城的独特名片。',itinerary:[
    ...
    xining: {name:'西宁',country:'青海',tag:'夏都西宁',rating:4.4,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb?w=800&q=80',description:'西宁，青海省省会，被誉为"夏都"。青海湖的碧波万顷、塔尔寺的藏传佛教文化、茶卡盐湖的天空之镜，让这座城市成为青藏高原上一颗璀璨的明珠。',itinerary:[
    ...
    yinchuan: {name:'银川',country:'宁夏',tag:'塞上江南',rating:4.3,days:'4天3晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1559737558-2f5a35a4b76e?w=800&q=80',description:'银川，宁夏回族自治区首府，"塞上江南"的美称。西夏王陵的千年神秘、沙湖的沙漠与湖泊共生、镇北堡西部影城的电影情怀，让人感受到西北大地的独特魅力。',itinerary:[
    ...
    urumqi: {name:'乌鲁木齐',country:'新疆',tag:'亚心之都',rating:4.5,days:'6天5晚',price:'¥2,799',img:'https://images.unsplash.com/photo-1519681393784-d120267933ba?w=800&q=80',description:'乌鲁木齐，新疆维吾尔自治区首府，亚洲大陆的地理中心。天山天池的雪山倒影、大巴扎的异域风情、南山牧场的辽阔草原，让你感受多元文化交融的独特魅力。',itinerary:[
    ...
    // 额外城市
    guilin: {name:'桂林',country:'广西',tag:'山水甲天下',rating:4.8,days:'5天4晚',price:'¥1,499',img:'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800&q=80',description:'桂林，"桂林山水甲天下"名扬四海。漓江的百里画廊、阳朔的十里画廊、龙脊梯田的壮美、象鼻山的奇特，构成了一幅流动的山水画卷。',itinerary:[
    ...
    dali: {name:'大理',country:'云南',tag:'风花雪月',rating:4.7,days:'4天3晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&q=80',description:'大理，"风花雪月"的浪漫之地。洱海的碧波、苍山的雪顶、大理古城的悠然、崇圣寺三塔的庄严，让这座古城成为无数人心中的诗和远方。',itinerary:[
...
const optionDetails = {
    ...
    nanjing_7d: {
        name: '南京+苏州+杭州 7天6晚',
        price: '¥3,999',
        img: 'https://images.unsplash.com/photo-1599571234902-5180d2b1c58d?w=800&q=80',
