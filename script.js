...
const destinationData = {
    ...
    // ==== 热门旅游城市 ====
    suzhou: {name:'苏州',country:'江苏',tag:'江南园林甲天下',rating:4.7,days:'4天3晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'苏州，"上有天堂，下有苏杭"。拙政园的亭台楼榭、留园的曲径通幽、周庄的小桥流水、虎丘的千年斜塔，无处不彰显着江南水乡的诗情画意。',itinerary:[
    ...
    lijiang: {name:'丽江',country:'云南',tag:'雪山下的古城',rating:4.8,days:'5天4晚',price:'¥1,299',img:'https://images.unsplash.com/photo-1496564203457-11bb12075d90',description:'丽江，一个让人心灵栖息的远方。大研古城的纳西风情、玉龙雪山的巍峨壮丽、束河古镇的宁静悠然、泸沽湖的摩梭文化，每一处都是诗和远方的模样。',itinerary:[
    ...
    xishuangbanna: {name:'西双版纳',country:'云南',tag:'热带雨林傣族风情',rating:4.6,days:'5天4晚',price:'¥1,699',img:'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05',description:'西双版纳，中国唯一的热带雨林自然保护区。野象谷的亚洲象、望天树的空中走廊、傣族园的竹楼、星光夜市的烟火，让你感受浓郁的民族风情和热带风光。',itinerary:[
    ...
    huangguoshu: {name:'黄果树',country:'贵州',tag:'亚洲最大瀑布',rating:4.6,days:'3天2晚',price:'¥1,599',img:'https://images.unsplash.com/photo-1482938289607-e9573fc25ebb',description:'黄果树瀑布，亚洲最大的瀑布，宽101米，高78米。奔腾而下的水流如银河倾泻，水雾弥漫，彩虹横跨，气势磅礴。景区内还有天星桥、陡坡塘等多个景点。',itinerary:[
    ...
    leshan: {name:'乐山',country:'四川',tag:'世界最大石刻坐佛',rating:4.6,days:'3天2晚',price:'¥1,399',img:'https://images.unsplash.com/photo-1486911278844-a81c5267e227',description:'乐山，举世闻名的乐山大佛所在地。大佛通高71米，是世界上最大的石刻弥勒佛坐像，历时90年建成。登临大佛脚下，感受"山是一尊佛，佛是一座山"的震撼。',itinerary:[
